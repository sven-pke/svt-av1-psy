...
:help
    ...
    echo Usage: build.bat [2022^|2019^|2017^|2015^|clean] [release^|debug] [nobuild] [test] [shared^|static] [c-only] [avx512] [enable-libdovi] [hdr] [no-apps] [no-enc] [external-cpuinfo]
    exit /b 1
goto :EOF
